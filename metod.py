...
'=='.join(['1', '22'])  # соединяет строки принимаемого списка, соединяя из строкой '==' возвращает СТРОКУ
...
import random as rd  # вызов модуля с псевдонимом
...
print(randint)  # тоже работает т.к. импортировать отдельно
