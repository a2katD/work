...
''.join([str(i) for i in [1, 2, 99, 4, 5]])  # если надо привратить инт в строку и соединить
...
string.zfill(2) # дополняет строку нулями до размера 2
...
listed.append([1, 2, 3])  # принимает одно значение, и добавляет его в конец списка, возвращает None
...
dict.fromkeys(['a', 'b', 'c'], 100)  # возвращает словарь из ключей a,b,c, со значениями 100
...
# a | b  # возвращает объеденённые множества (побитовое И) 100001 | 001110 = 101111
