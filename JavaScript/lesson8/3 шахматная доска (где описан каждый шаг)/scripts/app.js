let app = {
    ...
    insertPawns() {
        ...
        // тут было оч сложно, подглядел в решении =)
...
// я где-то напортачил в insertColsChars, т.к. буквы не отображаются
// и с цветом пешек беда, к сожалению времени у меня не остается, и сдаю как есть
// разок подглядел в решение, остальное обязательно доделаю сам, очено инетресная реализация спасибо!
